...
class SatisfyProjectsAndDiversifyFemaleMinOf2AndDiversifyRaceMinOf2With100TrialsRun(Run):
    @staticmethod
    ...
    def start(
        ...
        for class_size in class_sizes:
            ...
            cache_key = f"algorithms_comparison/sanity_check/100_trials_run/class_size_{class_size}"
...
if __name__ == "__main__":
    # To run this, run: python -m benchmarking.runs.algorithms_comparison.satisfy_projects_and_diversify_female_min_of_2_and_diversify_race_min_of_2.run100trials.satisfy_projects_and_diversify_female_min_of_2_and_diversify_race_min_of_2
    typer.run(SatisfyProjectsAndDiversifyFemaleMinOf2AndDiversifyRaceMinOf2With100TrialsRun().start)
