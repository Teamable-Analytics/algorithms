...
class ComplexTimeslotCustomStudentProvider(StudentProvider):
    def __init__(self):
        self.class_size = 8
    ...
    def get(self, seed: int = None) -> List[Student]:
        students = [
            ...
            Student(
                _id=3,
                attributes={
                    ScenarioAttribute.TIMESLOT_AVAILABILITY.value: [2, 3, 4, 5, 6],
                },
            ),
            Student(
                _id=4,
                attributes={
                    ScenarioAttribute.TIMESLOT_AVAILABILITY.value: [1, 3, 5, 6],
                },
            ),
            Student(
                _id=5,
