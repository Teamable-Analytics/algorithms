...
from benchmarking.evaluations.scenarios.concentrate_timeslot_diversify_gender_min_2 import \
    ConcentrateTimeslotAndDiversifyGenderMin2FemaleAndDiversifyRaceMin2African
from benchmarking.runs.interfaces import Run
from benchmarking.runs.priority_algorithm.concentrate_timeslots_and_diversify_gender_min_2_female_diversify_race_min_2_african.custom_dataclasses import \
...
class ConcentrateTimeslotsAndDiversifyGenderMin2FemaleDiversifyRaceMin2AfricanRun(Run):
    @staticmethod
    ...
    def start(self, num_trials: int = 100, generate_graphs: bool = True, analyze: bool = False):
        scenario = ConcentrateTimeslotAndDiversifyGenderMin2FemaleAndDiversifyRaceMin2African(max_num_choices=5)
        ...
        for class_size in class_sizes:
            ...
            cache_key = f"timeslot_runs/concentrate_timeslots_and_diversify_gender_min_2_female_diversify_race_min_2_african/class_size_{class_size}"
...
if __name__ == "__main__":
    typer.run(ConcentrateTimeslotsAndDiversifyGenderMin2FemaleDiversifyRaceMin2AfricanRun().start)
