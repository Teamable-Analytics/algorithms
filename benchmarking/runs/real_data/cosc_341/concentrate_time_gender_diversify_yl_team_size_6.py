...
class ConcentrateTimeGenderDiversifyYLTeamSize6(Run):
    """
    This run focuses on the scenario of concentrating timeslots, diversifying females with min 2, and diversifying based on year level (third year vs. graduate students). This corresponds with scenario 6 for the COSC 341 data.
    """
...
if __name__ == "__main__":
    typer.run(ConcentrateTimeGenderDiversifyYLTeamSize6().start)
