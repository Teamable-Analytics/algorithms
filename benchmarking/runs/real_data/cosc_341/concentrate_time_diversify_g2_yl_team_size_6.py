...
class ConcentrateTimeDiversifyG2YLTeamSize6(Run):
    """
    This run focuses on the scenario of concentrating timeslots, diversifying all genders with min 2 (female > non-binary > male > no answer), and diversifying based on year level (third year vs. graduate students). This corresponds with scenario 4 for the COSC 341 data.
    """
    ...
    def start(self, num_trials: int = 1, compute_metrics: bool = True):
        ...
        cache_key = "real_data/cosc_341/concentrate_time_diversify_g2_yl_team_size_6"
...
if __name__ == "__main__":
    typer.run(ConcentrateTimeDiversifyG2YLTeamSize6().start)
