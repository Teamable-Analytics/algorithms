...
class ConcentrateTimeDiversifyF2YL(Run):
    """
    This run focuses on the scenario of concentrating timeslots, diversifying females with min 2, and diversifying based on year level (third year vs. graduate students). This corresponds with scenario 1 for the COSC 341 data.
    """
    ...
    def start(self, num_trials: int = 1, compute_metrics: bool = False):
        ...
        cache_key = "real_data/cosc_341/concentrate_time_diversify_f2_yl"
...
if __name__ == "__main__":
    typer.run(ConcentrateTimeDiversifyF2YL().start)
