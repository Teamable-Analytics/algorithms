...
from benchmarking.evaluations.scenarios.cosc341.concentrate_timeslot_concentrate_gender_diversify_year_level import (
    ConcentrateTimeslotConcentrateGenderDiversifyYearLevel,
...
class ConcentrateTimeGenderDiversifyYL(Run):
    """
    This run focuses on the scenario of concentrating timeslots, diversifying females with min 2, and diversifying based on year level (third year vs. graduate students). This corresponds with scenario 5 for the COSC 341 data.
    """
    ...
    def start(self, num_trials: int = 1, compute_metrics: bool = False):
        ...
        cache_key = "real_data/cosc_341/concentrate_time_gender_diversify_yl"
...
if __name__ == "__main__":
    typer.run(ConcentrateTimeGenderDiversifyYL().start)
