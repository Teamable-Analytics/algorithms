...
class MockAlgorithm2:
    ...
    def field_names_for_algorithm_type_options(
        ...
        algorithm_options_cls = MockAlgorithm2.algorithm_options_class(algorithm_type)
    ...
    def algorithm_options_from_scenario(
        ...
        priorities = MockAlgorithm2.extract_priorities_from_goals(
        ...
        algorithm_options_class = MockAlgorithm2.algorithm_options_class(algorithm_type)
        specific_kwargs = prune_dictionary_keys(
            kwargs,
            MockAlgorithm2.field_names_for_algorithm_type_options(algorithm_type),
        )
