...
from algorithms.ai.interfaces.algorithm_config import SocialAlgorithmConfig
from algorithms.ai.interfaces.algorithm_options import (
    SocialAlgorithmOptions,
    WeightAlgorithmOptions,
)
from algorithms.ai.social_algorithm.clique_finder import CliqueFinder
from algorithms.ai.social_algorithm.custom_dataclasses import TeamWithCliques
from algorithms.ai.social_algorithm.evaluation import TeamEvaluation
from algorithms.ai.social_algorithm.social_graph import SocialGraph
from algorithms.ai.social_algorithm.utils import (
    next_empty_team,
    has_empty_teams,
...
from algorithms.ai.utils import save_students_to_team, generate_with_choose
from algorithms.ai.weight_algorithm.utility import (
    get_social_utility,
