...
from team_generator.algorithm.consts import FRIEND, DEFAULT, ENEMY
from team_generator.algorithm.utility import get_requirement_utility, get_social_utility, \
