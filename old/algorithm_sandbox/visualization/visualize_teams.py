        ...
        [
            ...
            html.Div(
                [
                    ...
                    dcc.Dropdown(
                        ["Display All", "Friends Only", "Enemies Only"],
                        "Display All",
                        id="edge-dropdown",
                    ),
                ]
        ...
        for student in visualize_logs.all_students:
            ...
            for target_id, relationship_value in student.relationships.items():
                ...
                if relationship_value == FRIEND and value == "Enemies Only":
                    continue
                visualize_logs.draw_relationship_edge(
                    student.id, target_id, relationship_value
                )

        data = {"nodes": visualize_logs.nodes, "edges": visualize_logs.edges}
        log_iteration = (
            f"Current Algorithm iteration: {visualize_logs.state_index}\n"
